...
class gsp_svj_nonTeachingFormcreateExperience_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/nonTeachingForm/createExperience.gsp" }
public Object run() {
Writer out = getOut()
...
createTagBody(2, {->
printHtmlPart(10)
invokeTag('render','g',230,['template':("experienceform")],-1)
printHtmlPart(11)
invokeTag('submitButton','g',244,['name':("create"),'class':("btn green"),'style':("margin-left:250px"),'value':(message(code: 'default.button.Submit.label', default: 'Save & Continue')),'id':("techingva65"),'data-toggle':("modal"),'data-target':("#exampleModalLong"),'onclick':("return confirm('Please verify all the details before saving Once Saved details can not be edited.')")],-1)
printHtmlPart(12)
})
invokeTag('form','g',245,['url':([resource:formDetailInstance, action:'experienceDetails']),'class':("form-horizontal"),'enctype':("multipart/form-data"),'id':("teach")],2)
printHtmlPart(13)
...
public static final long LAST_MODIFIED = 1667896996000L
