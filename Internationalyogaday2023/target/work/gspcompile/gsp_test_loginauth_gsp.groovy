...
class gsp_test_loginauth_gsp extends GroovyPage {
...
invokeTag('captureBody','sitemesh',401,['class':(" login"),'style':("background-image: url('../assets1/pages/img/B6.png'); background-repeat: no-repeat; background-attachment: fixed; background-position: center; background-size: cover; position: relative; margin: -78px auto 0 !important;")],1)
printHtmlPart(31)
}
...
public static final long LAST_MODIFIED = 1675768492585L
