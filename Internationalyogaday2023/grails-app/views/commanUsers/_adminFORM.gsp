...
<g:if test="${flash.message}">
	<div class="alert alert-danger" id="mydiv">
		<div class="text-center" style="color: #000;" role="status">
			<span class="badge badge-pill badge-success">Success</span> <b>
				${flash.message}
			</b>
		</div>
	</div>
...
<g:form controller="commanUsers" enctype="multipart/form-data"
...
--%>
		...
		<g:if test="${params?.action !="adminEdit"}">
			...
			<br>
			<g:actionSubmit action="SaveCommanUsers" class="btn btn-primary"
