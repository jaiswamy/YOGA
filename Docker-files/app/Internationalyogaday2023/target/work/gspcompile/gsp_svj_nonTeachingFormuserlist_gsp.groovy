...
class gsp_svj_nonTeachingFormuserlist_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/nonTeachingForm/userlist.gsp" }
public Object run() {
Writer out = getOut()
...
invokeTag('link','g',175,['controller':("superadmin"),'action':("indexx")],3)
printHtmlPart(9)
})
invokeTag('ifAnyGranted','sec',176,['roles':("ROLE_ADMIN")],2)
printHtmlPart(10)
createTagBody(2, {->
printHtmlPart(7)
createClosureForHtmlPart(8, 3)
invokeTag('link','g',182,['controller':("superadmin"),'action':("dashboard")],3)
printHtmlPart(9)
})
invokeTag('ifAnyGranted','sec',183,['roles':("ROLE_COMMANUSERS")],2)
printHtmlPart(11)
invokeTag('render','g',188,['template':("/header/topBar")],-1)
printHtmlPart(12)
loop:{
int i = 0
...
printHtmlPart(17)
invokeTag('formatDate','g',247,['date':(formDetailInstance.dateCreated)],-1)
printHtmlPart(18)
...
invokeTag('captureBody','sitemesh',397,['class':("page-container-bg-solid")],1)
printHtmlPart(21)
}
...
public static final long LAST_MODIFIED = 1664800002000L
