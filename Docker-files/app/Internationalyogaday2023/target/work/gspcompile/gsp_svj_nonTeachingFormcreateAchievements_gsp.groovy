...
class gsp_svj_nonTeachingFormcreateAchievements_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/nonTeachingForm/createAchievements.gsp" }
public Object run() {
Writer out = getOut()
...
createTagBody(2, {->
printHtmlPart(10)
invokeTag('render','g',230,['template':("achievementsform")],-1)
printHtmlPart(11)
...
invokeTag('form','g',245,['url':([resource:nonTeachingFormInstance, action:'achievementsDetails']),'class':("form-horizontal"),'enctype':("multipart/form-data"),'id':("teach")],2)
printHtmlPart(13)
...
printHtmlPart(14)
createClosureForHtmlPart(15, 3)
invokeTag('form','g',587,['url':([resource:formDetailInstance, action:'delete']),'method':("DELETE")],3)
printHtmlPart(14)
}
else {
printHtmlPart(16)
createClosureForHtmlPart(17, 3)
invokeTag('link','g',592,['class':("btn btn blue btn-primary"),'action':("show"),'resource':(formDetailInstance)],3)
printHtmlPart(18)
}
printHtmlPart(22)
if(true && (formDetailInstance?.paymentInfoId?.transactionId == null)) {
printHtmlPart(14)
createClosureForHtmlPart(15, 3)
invokeTag('form','g',639,['url':([resource:formDetailInstance, action:'delete']),'method':("DELETE")],3)
printHtmlPart(14)
}
else {
printHtmlPart(16)
createClosureForHtmlPart(17, 3)
invokeTag('link','g',650,['class':("btn btn blue btn-primary"),'action':("show"),'resource':(formDetailInstance)],3)
printHtmlPart(18)
}
printHtmlPart(23)
})
...
public static final long LAST_MODIFIED = 1667993780000L
