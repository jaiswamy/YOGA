...
class gsp_test_formDetailthankyou_gsp extends GroovyPage {
...
invokeTag('link','g',342,['class':("btn btn-primary"),'controller':("formDetail"),'action':("adminformDetails"),'resource':(formDetailInstance)],3)
printHtmlPart(14)
})
...
createTagBody(3, {->
printHtmlPart(12)
invokeTag('message','g',354,['code':("default.button.Click here.label"),'default':("Click here")],-1)
printHtmlPart(13)
})
invokeTag('link','g',354,['class':("btn green"),'controller':("formDetail"),'action':("index"),'resource':(formDetailInstance)],3)
printHtmlPart(14)
})
...
public static final long LAST_MODIFIED = 1675768299491L
