...
class gsp_svj_nonTeachingFormcreateEducation_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/nonTeachingForm/createEducation.gsp" }
public Object run() {
Writer out = getOut()
...
createTagBody(2, {->
printHtmlPart(10)
invokeTag('render','g',230,['template':("educationform")],-1)
printHtmlPart(11)
invokeTag('submitButton','g',244,['name':("create"),'class':("btn green"),'style':("margin-left:250px"),'value':(message(code: 'default.button.Submit.label', default: 'Save & Continue')),'id':("techingva1"),'data-toggle':("modal"),'data-target':("#exampleModalLong"),'onclick':("return confirm('Please verify all the details before saving Once Saved details can not be edited.')")],-1)
printHtmlPart(12)
})
invokeTag('form','g',245,['url':([resource:formDetailInstance, action:'educationDetails']),'class':("form-horizontal"),'enctype':("multipart/form-data"),'id':("teach")],2)
printHtmlPart(13)
...
printHtmlPart(14)
createClosureForHtmlPart(15, 3)
invokeTag('form','g',474,['url':([resource:nonTeachingFormInstance, action:'delete']),'method':("DELETE")],3)
printHtmlPart(14)
}
else {
printHtmlPart(16)
...
printHtmlPart(16)
createClosureForHtmlPart(17, 3)
invokeTag('link','g',535,['class':("btn btn blue btn-primary"),'action':("show"),'resource':(nonTeachingFormInstance)],3)
printHtmlPart(18)
}
printHtmlPart(21)
if(true && (nonTeachingFormInstance?.paymentInfoId?.transactionId == null)) {
...
printHtmlPart(16)
createClosureForHtmlPart(17, 3)
invokeTag('link','g',593,['class':("btn btn blue btn-primary"),'action':("show"),'resource':(nonTeachingFormInstance)],3)
printHtmlPart(18)
}
printHtmlPart(22)
if(true && (nonTeachingFormInstance?.paymentInfoId?.transactionId == null)) {
...
public static final long LAST_MODIFIED = 1667909878000L
