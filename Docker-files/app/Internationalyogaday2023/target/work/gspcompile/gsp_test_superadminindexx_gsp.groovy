...
class gsp_test_superadminindexx_gsp extends GroovyPage {
...
invokeTag('ifAnyGranted','sec',700,['roles':("ROLE_ADMIN")],2)
printHtmlPart(8)
invokeTag('render','g',715,['template':("/header/topBar")],-1)
printHtmlPart(9)
createClosureForHtmlPart(10, 2)
invokeTag('link','g',741,['controller':("formDetail"),'action':("adminformDetails")],2)
printHtmlPart(11)
})
invokeTag('captureBody','sitemesh',880,['class':("page-container-bg-solid")],1)
printHtmlPart(12)
}
...
public static final long LAST_MODIFIED = 1675935857836L
