...
class gsp_svj_nonTeachingFormthankyou_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/nonTeachingForm/thankyou.gsp" }
public Object run() {
Writer out = getOut()
...
createTagBody(2, {->
printHtmlPart(6)
invokeTag('message','g',289,['code':("default.button.Click here.label"),'default':("Click here")],-1)
})
invokeTag('link','g',289,['class':("btn green"),'action':("index"),'resource':(nonTeachingFormInstance)],2)
printHtmlPart(7)
})
invokeTag('captureBody','sitemesh',390,['class':("page-container-bg-solid")],1)
printHtmlPart(8)
}
...
public static final long LAST_MODIFIED = 1657260626000L
