...
class gsp_test_formDetailpaymentfailed_gsp extends GroovyPage {
...
createTagBody(3, {->
printHtmlPart(12)
invokeTag('message','g',346,['code':("default.button.Click here.label"),'default':("Click here")],-1)
printHtmlPart(13)
})
invokeTag('link','g',346,['class':("btn btn-primary"),'action':("adminformDetails"),'resource':(formDetailInstance)],3)
printHtmlPart(14)
})
...
public static final long LAST_MODIFIED = 1675768269682L
