...
class gsp_svj_nonTeachingFormcreateDocuments_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/nonTeachingForm/createDocuments.gsp" }
public Object run() {
Writer out = getOut()
...
createTagBody(2, {->
printHtmlPart(10)
invokeTag('render','g',230,['template':("documentsform")],-1)
printHtmlPart(11)
invokeTag('submitButton','g',244,['name':("create"),'class':("btn green"),'style':("margin-left:250px"),'value':(message(code: 'default.button.Submit.label', default: 'Submit')),'id':("techingva2"),'data-toggle':("modal"),'data-target':("#exampleModalLong"),'onclick':("return confirm('Please verify all the details before submitting Once Submitted details can not be edited.')")],-1)
printHtmlPart(12)
})
invokeTag('form','g',245,['url':([resource:formDetailInstance, action:'documentsDetails']),'class':("form-horizontal"),'enctype':("multipart/form-data"),'id':("teach")],2)
printHtmlPart(13)
if(true && (nonTeachingFormInstance?.paymentInfoId?.transactionId == null)) {
printHtmlPart(14)
createClosureForHtmlPart(15, 3)
invokeTag('form','g',423,['url':([resource:nonTeachingFormInstance, action:'delete']),'method':("DELETE")],3)
printHtmlPart(14)
}
else {
printHtmlPart(16)
...
public static final long LAST_MODIFIED = 1667994458000L
